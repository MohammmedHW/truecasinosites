...
if($_POST['menufoot'])
    ...
    $data = array(
        ...
        'top_desc' => addslashes($_POST['top_desc']),
        'foot_desc' => addslashes($_POST['foot_desc']),
        'menutop' => $menutop,
        'menufoot' => $menufoot,
...
//        $data['updated_at'] = strtotime("now");
 //       $data['updated_by'] = $_SESSION['user_id'];
    ...
    if($insert) {
        ...
        activity_employee($_SESSION['user_id'],'activity_offer','activity_category_successfully'.'#','success');
...
if((isset($_REQUEST['action'])) && ($_REQUEST['action']=='del')){
    ...
    if($farmer['total_rows'] == '0'){
       ...
       // $where_condition  = "cbid = '".$_GET['id']."' ";
        ...
        activity_employee($_SESSION['user_id'],'activity_offer','delete_category_successfully'.'#'.$_GET['id'],'success');
