...
include_once(dirname(realpath(dirname(__FILE__))).'/function/config.inc.php');
	...
	$aColumns = array('id','name', 'mobile','email', 'status');
	...
	//$aRow = mysql_fetch_array( $rResult ) ;
		...
		$row[] =' <a href="staff.php?id='.$aRow['id'].'"><i class="fa fa-edit"></i></a>';
/*		<div class="btn-group"> <a class="btn btn-mini btn-success dropdown-toggle btn-demo-space" data-toggle="dropdown" href="#">Action <span class="caret"></span> </a>
					<ul class="dropdown-menu">
					  <li><a href="staff.php?id='.$aRow['sid'].'">Edit</a></li>
					  <li class="divider"></li>
					  <li><a href="php/staff.php?action=del&id='.$aRow['sid'].'" >Delete</a></li>
					</ul>
				  </div>';
