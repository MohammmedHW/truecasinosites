...
include_once(dirname(realpath(dirname(__FILE__))).'/function/config.inc.php');
	...
	$aColumns = array('id','title','category', 'bonus_amount','rating','ranking','hits','status');
...
/*	if ( $sWhere == "" )
	...
	//$aRow = mysql_fetch_array( $rResult ) ;
		$catQuery = 'select name from pages WHERE id = "'.$aRow['category'].'"';
		...
		$row[] =' <div class="btn-group"> <a class="btn btn-mini btn-success dropdown-toggle btn-demo-space" data-toggle="dropdown" href="#">Action <span class="caret"></span> </a>
					<ul class="dropdown-menu">
					  <li><a href="offers.php?id='.$aRow['id'].'">Edit</a></li>
					  <li class="divider"></li>
					  <li><a href="php/offers.php?action=del&id='.$aRow['id'].'" >Delete</a></li>
					</ul>
				  </div>';
