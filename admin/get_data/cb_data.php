...
include_once(dirname(realpath(dirname(__FILE__))).'/function/config.inc.php');
	...
	$aColumns = array('cbid','name', 'contact_person', 'email','phone','mobile', 'add1', 'add2', 'village', 'taluka','district','state','pin','details','created_at','created_by','updated_at','updated_by','status');
	...
	//$aRow = mysql_fetch_array( $rResult ) ;
		...
		$row[] =' <div class="btn-group"> <a class="btn btn-mini btn-success dropdown-toggle btn-demo-space" data-toggle="dropdown" href="#">Action <span class="caret"></span> </a>
					<ul class="dropdown-menu">
					  <li><a href="cb.php?id='.$aRow['cbid'].'">Edit</a></li>
					  <li class="divider"></li>
					  <li><a href="php/cb.php?action=del&id='.$aRow['cbid'].'" >Delete</a></li>
					</ul>
				  </div>';
