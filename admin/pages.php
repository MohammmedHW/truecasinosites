...
if((isset($_GET['id'])) && ($_GET['id'] > 0)){
	...
	if($farmer['total_rows'] == '0'){
        ...
        $_SESSION['msg'] = "Page ID not found";
		$goto = 'view_page.php'; 
...
<script type="text/javascript">
  ...
  height: 500,
  theme: 'modern',
  plugins: 'responsivefilemanager autoresize bbcode charmap code contextmenu image   searchreplace autolink directionality visualblocks visualchars fullscreen image link media table charmap hr nonbreaking anchor insertdatetime advlist lists textcolor wordcount contextmenu ',
