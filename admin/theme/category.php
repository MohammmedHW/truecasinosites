...
<ul class="breadcrumb">
        ...
        <li><a href="#" class="active">Category Details</a> </li>
      </ul>
      <div class="page-title"> <i class="icon-custom-left"></i>
        <h3>Form - <span class="semi-bold">Add/Update Category</span></h3>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="grid simple">
			...
			<form class="form-no-horizontal-spacing validation" id="myform" action="php/category.php" method="post" role="form">	
...
<div class="col-md-6 <?php echo ($_REQUEST['id']==1)?"hide":"" ?>">
				...
				<div class="row form-row">
                      <div class="col-md-12">
                        <p>Icon </p>
         <input id="icon" name="icon" type="text" value="<?php echo $farmer['icon']; ?>">
         <a href="javascript:open_popup('<?php echo $app_vars['website_url'];?>admin/plugins/filemanager/dialog.php?type=1&popup=1&amp;field_id=icon')" class="btn btn-default" type="button">Image</a>
                <div class="col-md-6">
         <div id="cont-img"><img class="img-responsive" id="image_preview" src="<?php echo $farmer['icon']; ?>" style="max-height: 200px;" /></div>
       </div>
     </div>
       </div>

     </div>
     <div class="row form-row <?php echo ($_REQUEST['id']==1)?"hide":"" ?>">
          <div class="col-md-6">
          ...
          <div class="col-md-6">
             Foot Menu <input type="checkbox" name="menufoot" value="1" <?php echo ($farmer['menufoot']?'checked="checked"':'');?> >
                  ...
                  <h4>Page Desciption</h4>
                   <div class="row form-row">
                      <div class="col-md-12">
                        <p>Top Description</p>
                        <textarea style="width: 100%; height: 200px;" name="top_desc" placeholder="Top Description"><?php echo $farmer['top_desc']; ?></textarea>
                      </div>   
                     <div class="col-md-12">
                        <p>Foot Description</p>
                        <textarea style="width: 100%;  height: 200px;" name="foot_desc" placeholder="Foot Description"><?php echo $farmer['foot_desc']; ?></textarea>
                      </div>   
                    </div>
                </div>
 ...
 <br><br>
 <div class="row column-seperation">fffffffffff</div>             </div>
