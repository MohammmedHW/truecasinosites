...
include_once(dirname(realpath(dirname(__FILE__))).'/function/config.inc.php');
	...
	$aColumns = array('tid','title', 'contact_staff_id', 'email','phone','mobile', 'add1', 'add2', 'village', 'taluka','district','state','pin','details','created_at','created_by','updated_at','updated_by','type','points_covered','trainers','startdate','enddate','attandies','status');
	...
	//$aRow = mysql_fetch_array( $rResult ) ;
		...
		$row[] =' <div class="btn-group"> <a class="btn btn-mini btn-success dropdown-toggle btn-demo-space" data-toggle="dropdown" href="#">Action <span class="caret"></span> </a>
					<ul class="dropdown-menu">
					  <li><a href="training.php?id='.$aRow['tid'].'">Edit</a></li>
					  <li class="divider"></li>
					  <li><a href="php/training.php?action=del&id='.$aRow['tid'].'" >Delete</a></li>
					</ul>
				  </div>';
